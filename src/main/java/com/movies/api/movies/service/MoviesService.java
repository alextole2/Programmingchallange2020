...
public class MoviesService {
    ...
    public List<MoviesDto> getAll() {
        return toMoviesDto(moviesRepository.findAll());
    }

    public List<MoviesDto> getMoviesByYear(final int year) {
        return toMoviesDto(moviesRepository.getMoviesByYear(toEnclosedYearStr(year)));
    }
